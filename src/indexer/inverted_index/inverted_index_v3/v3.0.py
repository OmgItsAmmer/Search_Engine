...
def build_inverted_index(csv_file, lexicon_file, output_json_file, output_csv_file):
    ...
    for _, row in data.iterrows():
        ...
        columns_to_search = ['gender', 'masterCategory', 'subCategory', 'articleType', 'baseColour', 'season', 'year', 'usage']
...
# Example usage
csv_file = r"C:\Users\ammer\OneDrive\Desktop\SearchEngine\data\processed_data\barrels\merged_processed.csv" # CSV file with the required columns
lexicon_file = r"C:\Users\ammer\OneDrive\Desktop\SearchEngine\data\processed_data\lexicons\lexicon.json"  # Lexicon JSON file
output_json_file = r"C:\Users\ammer\OneDrive\Desktop\SearchEngine\data\processed_data\inverted_index\v3\inverted_index.json"  # Output file for the inverted index (JSON)
output_csv_file = r"C:\Users\ammer\OneDrive\Desktop\SearchEngine\data\processed_data\inverted_index\v3\inverted_index.csv"  # Output file for the inverted index (CSV)
